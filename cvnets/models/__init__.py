...
from .bokeh import arguments_bokeh, build_bokeh_model
...
def arguments_model(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    # bokeh_loss_fns network
    parser = arguments_bokeh(parser=parser)
...
def get_model(opts):
    ...
    elif dataset_category == "bokeh":
        model = build_bokeh_model(opts=opts)
    else:
        task_str = (
