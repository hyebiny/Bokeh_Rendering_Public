...
def get_bokeh_eval_arguments():
    parser = get_training_arguments(parse_args=False)

    group = parser.add_argument_group("Bokeh evaluation related arguments")

    group.add_argument(
        "--evaluation.bokeh.mode",
        type=str,
        default="validation_set",
        required=False,
        choices=["single_image", "image_folder", "validation_set"],
    ...
    group.add_argument(
        "--evaluation.bokeh.path",
        type=str,
        default=None,
        help="Path of the image or image folder (only required for single_image and image_folder modes)",
    )
    group.add_argument(
        "--evaluation.bokeh.num-classes",
        type=str,
        default=None,
        help="Number of segmentation classes used during training",
    )
    group.add_argument(
        "--evaluation.bokeh.resize-input-images",
        action="store_true",
        default=False,
        help="Resize the input images",
    )
